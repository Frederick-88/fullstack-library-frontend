...
const url = "https://fd-library.herokuapp.com/library";

export const addBookLibrary = (dataInitial) => {
  return (dispatch) => {
    axios.post(`${url}/post`, dataInitial).then((response) => {
...
export const editBookLibrary = (dataInitial) => {
  ...
  return (dispatch) => {
    axios
      .put(`${url}/edit/${dataInitial._id}`, dataInitial)
...
export const DeleteBookLibrary = (DataInitial) => {
  ...
  return (dispatch) => {
    axios
      .delete(`${url}/delete/${DataInitial._id}`, DataInitial)
...
export const GetDataLibrary = () => {
  return (dispatch) => {
    axios
      .get("https://fd-library.herokuapp.com/library/get")
